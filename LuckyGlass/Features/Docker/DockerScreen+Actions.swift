...
extension DockerScreen {
    ...
    private var runner: DockerActionRunner {
        let deleteSink = $imageDeleteProgress
        let composeSink = $composeProgress
        let taskSink = $tasks
        let loadedSink = $loaded
...
extension DockerScreen {
    ...
    private func runScan(_ targets: [String], _ id: Int) async {
        ...
        let progressSink = $unusedScanProgress
        let requestSink = $scanRequest
    ...
    private func runUpgradeSweep(_ references: [String], _ title: String, _ id: Int) async {
        let detailSink = $detail
        let requestSink = $detailRequest
